...
public class FunctionCallAlphabet
{
	public static void main( String[] args )
	{
		...
		f("Food");    // displays the word you pass it beginning with "F"
		System.out.print(g());    // returns the word to be displayed
		h(1);    // tell it how many times to display the word (1)
		System.out.println();

		i(5);    // pass it any integer and it will display a word beginning with I 
		System.out.print(j(2));    // returns a different word depending on what you pass it (1-3)
		...
		n("Newspaper");    // displays the word you pass it beginning with "N"
		...
		t("Trust");    // displays the word you pass it beginning with "T"
		System.out.print(u());    // returns the word to be displayed
		v(1);    // tell it how many times to display the word (1)
		w(7);    // pass it any integer and it will display a word beginning with W 
